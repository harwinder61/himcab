        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            @endif
	            ...
	            <form class="form-horizontal" method="post" action="{{url('/postLocalization')}}" id="profile_form" enctype="multipart/form-data">
	            	@csrf
	              
				<div class="form-group row ">
                  <label for="inputPhone" class="col-sm-3  col-form-label bmd-label-floating">Country</label>
                  <div class="col-sm-9">
                   <select  class="form-control" name="Country_id" onchange="getval(this)" required>
				...
				<div class="form-group row ">
                  ...
                  <div class="col-sm-9">
                   <select  class="form-control state_id" name="state_id" onchange="getcity(this)" required >
