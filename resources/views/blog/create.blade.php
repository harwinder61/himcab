        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            @endif
	            ...
	            <form class="form-horizontal" method="post" action="{{url('/postBlog')}}" id="profile_form" enctype="multipart/form-data">
	            	@csrf
                <div class="form-group row ">
                  <label for="inputPhone" class="col-sm-3 col-form-label bmd-label-floating">Title</label>
                  <div class="col-sm-9">
                    <input type="text" name="title"  class="form-control" id="inputPhone" placeholder="Title">
                  </div>
                </div>
	              <div class="form-group row">
